  ...
  return (
    ...
    >
      <VStack spacing={6}>
        ...
        {!hasMarkedToday ? (
          <>
            <Box w="full" bg={useColorModeValue('gray.50', 'gray.700')} p={3} borderRadius="md">
              <HStack justify="center" spacing={2} color={location ? "green.500" : "orange.500"}>
            ...
            {imagePreview && (
              <Box mb={1} w="full" borderRadius="md" overflow="hidden" border="2px solid" borderColor="green.200">
                <img
                  src={imagePreview}
                  alt="Selfie Preview"
